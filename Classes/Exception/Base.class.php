...
abstract class Exception_Base extends Exception
{
    ...
    protected function _traceHistory()
    {
        ...
        if( is_array( $traceArray ) ) {
            ...
            foreach( $traceArray as $key => $value  ) {
                ...
                $str .= '<div style="margin-top: 5px; padding: 5px; border: solid 1px #666666; background-color: FFFFFF;">' . $class . $function . $type . $file . $line . $args . $code . '</div>';
            }
        }
    ...
    protected function _getCode( $file, $line )
    {
        ...
        if( is_array( $lines ) ) {
            ...
            // Gets the given line
            $line3      = ( isset( $lines[ $line - 1 ] ) ) ? '<strong style="color: #FFAA00;">' . str_pad( $line, $lineLength, 0, STR_PAD_LEFT ) . ': ' . $lines[ $line -1 ] . '</strong>' : '';
            ...
            // Returns the lines
            return '<div style="' . self::$_commonStyles . ' white-space: pre; font-family: monospace; color: #FFFFFF; background-color: #666666; padding: 5px; margin-top: 5px;">' . $line0 . $line1 . $line2 . $line3 . $line4 . $line5 . $line6 . '</div>';
        }
    ...
    {        
        $trace = '<div style="' . self::$_commonStyles . ' background-color: #EEEEEE; border: solid 1px #666666; margin: 10px; padding: 10px;">'
