 ...
 * @version         0.1
 */
class Fp_Png_File implements Iterator, ArrayAccess
{
    /**
    ...
    public function addChunk( $chunkType )
    {
        ...
        if( $invalid && !$this->_allowInvalidStucture ) {
            ...
            // Invalid chunk
            throw new Fp_Png_Exception( $invalid, Fp_Png_Exception::EXCEPTION_INVALID_CHUNK );
        }
        
        // Name of the chunk class
        $className = 'Fp_Png_Chunk_' . ucfirst( strtolower( $chunkType ) );
        ...
        if( class_exists( $className ) ) {
            ...
            $chunk = new Fp_Png_UnknownChunk( $this, $chunkType );
        }
