 ...
 * @version         0.1
 */
class Fp_Gif_Parser extends Fp_Parser_Base
{
    /**
    ...
    protected function _parseFile()
    {
        ...
        if( $this->_read( 3 ) !== 'GIF' ) {
            ...
            // Wrong file type
            throw new Fp_Gif_Exception( 'File ' . $this->_filePath . ' is not a GIF file.', Fp_Gif_Exception::EXCEPTION_NOT_GIF );
        }
    ...
    protected function _parseBlock( $id, stdClass $infos )
    {
        ...
        switch( $id ) {
            ...
            default:
                ...
                throw new Fp_Gif_Exception( 'Invalid GIF block identifier: \'0x' . dechex( $id ) . '\'.', Fp_Gif_Exception::EXCEPTION_BAD_ID );
                break;
        }
    }
    ...
    protected function _parseExtensionBlock( $id, stdClass $infos )
    {
        ...
        switch( $id ) {
            ...
            default:
                ...
                throw new Fp_Gif_Exception( 'Invalid GIF extension block identifier: \'0x' . dechex( $id ) . '\'.', Fp_Gif_Exception::EXCEPTION_BAD_EXT_ID );
                break;
        }
    }
