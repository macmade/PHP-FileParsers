 ...
 * @version         0.3
 */
class Fp_Mpeg4_Parser extends Fp_Parser_Base
{
    /**
    ...
    /**
     * An instance of the Fp_Mpeg4_File class
     */
    ...
    public function __construct( $file, $allowInvalidStucture = false, $allowUnknownAtoms = false )
    {
        ...
        $this->_mpeg4File            = new Fp_Mpeg4_File();
    ...
    protected function _parseFile( $bytes = 0, $level = 0, $parent = NULL )
    {
        ...
        while( $chunk = $this->_read( 8 ) ) {
            ...
            if( $atomDataLength ) {
                ...
                if( $atomObject && is_subclass_of( $atomObject, 'Fp_Mpeg4_ContainerAtom' ) ) {
